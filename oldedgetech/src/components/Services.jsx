...
import softdev from '../img/softdev.jpeg'
import mobdev from '../img/mobdev.jpeg'
...
const Services = () => {
  return (
    ...
    <div className='grid grid-col-1 sm:grid-cols-3 md:grid-cols-3 items-center justify-center p-4'>
        <div className='flex flex-col items-center justify-center p-2 shadow-xl shadow-blue-400 rounded-lg mx-2 mb-12'>
            <h3 className='uppercase text-xl text-blue-800 mb-1'>Web Development</h3>
            <img src={webdev} alt="" className='rounded-full w-20 h-20 m-1 cursor-pointer'/>
        ...
        <div className='flex flex-col items-center justify-center p-2 shadow-xl shadow-blue-400 rounded-lg mx-2 mb-12'>
            ...
            <img src={softdev} alt="" className='rounded-full w-20 h-20 m-1 cursor-pointer'/>
        ...
        <div className='flex flex-col items-center justify-center p-2 shadow-xl shadow-blue-400 rounded-lg mx-2 mb-12'>
            ...
            <img src={mobdev} alt="" className='rounded-full w-20 h-20 m-1 cursor-pointer'/>
