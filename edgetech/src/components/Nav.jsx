    ...
    <nav className={` text-blue-600 font-bold ${isDarkMode ? 'bg-black ' : 'bg-white '}`}>
      <div className="container mx-auto px-4 py-2 flex  items-center justify-between">
        ...
        <div className="hidden lg:flex space-x-5 items-center">
          <ul className="lg:flex space-x-5 items-center">
            ...
            <li><a href="#team" className="hover:text-blue-800">Team</a></li>
            <li>
              <button className={`relative rounded-xl p-2 w-10 h-10 bg-gray-900 text-white focus:outline-none transition-colors duration-300 ${isDarkMode ? 'justify-end' : 'justify-start'}`}onClick={toggleDarkMode}>
      ...
      {isOpen && (
        <div className="lg:hidden py-2 px-4">
          ...
          <a href="#services" className="hover:text-blue-800 block py-1">Team</a>
          <a href="#projects" className="hover:text-blue-800 block py-1">Projects</a>
          <button className={`relative rounded-full p-2 w-10 h-10 bg-gray-900 text-white focus:outline-none transition-colors duration-300 ${isDarkMode ? 'justify-end' : 'justify-start'}`}onClick={toggleDarkMode}>
              ...
              <br />
              <br />
              <button className={isDarkMode ? 'bg-gray-900 rounded p-2 hover:bg-gray-700 hover:text-blue-800' : 'bg-gray-100 rounded p-2 hover:bg-gray-300 hover:text-blue-400'}><a href="#contact">Contact</a></button>
        </div>
      )}
    </nav>
  );
