      ...
      <div className='flex flex-col items-center'>
        ...
        <span className='text-gray-800 flex m-2'>
          <a href="mailto:edgetech224@gmail.com">
            <AiOutlineMail className='m-2 cursor-pointer hover:scale-150 ease-in duration-300' />
          </a>
          <a href="https://github.com/PeaceOloruntoba">
            <FaGithub className='m-2 cursor-pointer hover:scale-150 ease-in duration-300' />
          </a>
          <a href="https://facebook.com/">
            <FaFacebook className='m-2 cursor-pointer hover:scale-150 ease-in duration-300' />
          </a>
          <a href="https://instagram.com/">
            <FaInstagram className='m-2 cursor-pointer hover:scale-150 ease-in duration-300' />
          </a>
          <a href="https://twitter.com/">
            <FaTwitter className='m-2 cursor-pointer hover:scale-150 ease-in duration-300' />
          </a>
          <a href="https://wa.me/2348166846226/">
            <FaWhatsapp className='m-2 cursor-pointer hover:scale-150 ease-in duration-300' />
          </a>
        </span>
      </div>
