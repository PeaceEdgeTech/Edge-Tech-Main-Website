...
const Portfolio = () => {
  return (
    <div id="projects" className="h-3/4 mx-12 text-gray-600">
      <div className="container mx-auto">
        ...
        <div className="flex justify-center bg-gray-100 mt-6">
          <div className="grid grid-cols-1 my-12 sm:grid-cols-2 md:grid-cols-3 lg:gap-20 gap-4 md:gap-10 mt-8">
            <div className="group relative bg-white p-4 border-2 border-blue-600 rounded-lg transition duration-300 hover:bg-black">
